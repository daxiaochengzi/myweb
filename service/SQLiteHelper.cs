...
namespace service
{
    public static class SQLiteHelper
    {
        ...
        public static string connectionString = "Data Source=MyDatabase";
            ...
            int pageSize, int currentIndex, out int recordOut)
        {
            ...
            string commandText = String.Format(pagingTemplate, strColumns, tableName, strWhere, strOrder,
        ...
        private static void PrepareCommand(SQLiteCommand cmd, SQLiteConnection conn, ref SQLiteTransaction trans,
            bool useTrans, CommandType cmdType, string cmdText, params SQLiteParameter[] cmdParms)
        {
