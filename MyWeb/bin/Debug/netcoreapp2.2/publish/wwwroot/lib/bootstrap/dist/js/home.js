...
function Btn_Click() {
    var Tablearrselections = $("#tb_departments").bootstrapTable('getSelections');
    var fileUpload = $("#files").get(0);
    var files = fileUpload.files;
    var data = new FormData();
    if (files.length > 4) {
        toastr.warning("图片数量最多4张!!!");
        return;
